	...
	mapDemo.Directions = (function() {
		function _Directions() {
			var map,   
				...
				markerA = new google.maps.MarkerImage('http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=A|458b00|000000',
						new google.maps.Size(24, 27),
						new google.maps.Point(0, 0),
						new google.maps.Point(12, 27)),		
				markerB = new google.maps.MarkerImage('http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=B|FF0000|000000',
				...
				mapSetup = function() {					
					map = new google.maps.Map($Selectors.mapCanvas, {
							zoom: 4,
							center: new google.maps.LatLng(58.583333, 25.783333),	
				...
				directionsRender = function(source, destination) {
					...
					directionsDisplay.setMap(MapsLib.map);
					...
					directionsService.route(request, function(response, status) {
						if (status == google.maps.DirectionsStatus.OK) {
							...
							pinA = new google.maps.Marker({position: _route.start_location, map: MapsLib.map, icon: markerA}), 
							pinB = new google.maps.Marker({position: _route.end_location, map: MapsLib.map, icon: markerB});																	
						}
					});
