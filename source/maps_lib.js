...
$.extend(MapsLib, {
    ...
    queueInfobox:       false,
    nearbyPinInfobox:   MapsLib.nearbyPinInfobox || "Asud siin.",
    ...
    initDefaults: function() {
        ...
        {
            // default to US
            MapsLib.searchPage.addressAutocomplete.country = "ee";
        }
    },
    ...
    initialize: function() {
        ...
        else 
        {
            ...
            var nearbyLocationDefaults = {
                ...
                boundsExceededMessage: "Asud väljaspool sisestatud andmepunkte.",
        ...
        getlocation = function() {
            ...
            {
                alert("Seade ei jaga Sinu asukohta .");
            }
            return false;
        }
    ...
    searchHtml: function() {
        ...
        if (settings.addressShow)
        {
            html.push("<label for='search_address'>Address / Asukoht:</label>");
            html.push("<input class='input-block-level' data-clear-btn='true' id='search_address' placeholder='Sisestatud koht asub kaardi keskel' type='text' />");
        }
        if (settings.distanceFilter.entries.length > 0)
        {
            html.push("<hr><label for='search_radius'>Otsimisraadius:</label>");
    ...
    updateListView: function() {
        ...
        if (MapsLib.listViewRows.length == 0)
        {
            $("ul#listview").html('<li data-corners="false" data-shadow="false" data-iconshadow="true" data-theme="d">Nimekirja laadimine...</li>');
        }
